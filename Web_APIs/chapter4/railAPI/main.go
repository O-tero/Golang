...
import (
	...
	"github.com/web_apis/chapter4/dbutils"
...
// Train resource is the model for hodling rail information
...
// ScheduleResouce links both trains and stations
...
// Registers adds paths and rorutes to a new service instance
...
// Decodes body of incoming request 
// then prepares database query statement into body data
func (t TrainResource) createTrain(request *restful.Request, response *restful.Response) {
		...
		// Error handling is obvious here. So ommitting..
...
func main() {
		...
		wsContainer.Router(restful.CurlyRouter{}) // allows us to use train_id syntax in paths while setting routes
		t := TrainResource{}
