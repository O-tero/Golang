...
func main() {
	...
	// Defines which queue to consume and its properties
	...
	// Runs a go-routine that spawns a function that runs
	// an infinite loop to collect messages and process them
	go func() {
